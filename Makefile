...
# Template: app
# Command: C:\Qt\Qt5.5.1\5.5\mingw492_32\bin\qmake.exe -spec win32-g++ "CONFIG+=debug" -o Makefile NFWizard2.pro
#############################################################################
...
Makefile: NFWizard2.pro C:/Qt/Qt5.5.1/5.5/mingw492_32/mkspecs/win32-g++/qmake.conf C:/Qt/Qt5.5.1/5.5/mingw492_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec win32-g++ "CONFIG+=debug" -o Makefile NFWizard2.pro
